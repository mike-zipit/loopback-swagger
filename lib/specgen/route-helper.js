...
var routeHelper = module.exports = {
  ...
  routeToPathEntry: function(route, classDef,
    ...
    var accepts = routeHelper.convertAcceptsToSwagger(route, classDef,
                                                      typeRegistry, opts);
    var consumes = undefined;
    for (var i=0; i<accepts.length; i++) {
      if (accepts[i].in === 'formData') {
    ...
    var entry = {
      ...
      operation: {
        ...
        // [drmikecrowe] we need a special consumes for formData with swagger-v3
        consumes: consumes,
        // [bajtos] we are omitting produces, as they are same
