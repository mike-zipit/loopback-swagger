...
var modelHelper = module.exports = {
   ...
   */
  registerModelDefinition: function(modelCtor, typeRegistry, securityDefinitions, opts) {
...
var definitionFunction = function(modelCtor, typeRegistry, securityDefinitions, options) {
  var lbdef = modelCtor.definition;
  ...
  function addSwaggerSecurity(lbdef, typeRegistry, securityDefinitions) {
    ...
    var acls = lbdef.settings && lbdef.settings.acls ? lbdef.settings.acls : {};
    for (var i in acls) {
      var acl = acls[i];
